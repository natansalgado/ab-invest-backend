...
namespace AB_INVEST.Migrations
{
    ...
    [Migration("20240209194744_CreateWithdrawTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AB_INVEST.Models.TransferModel", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        ...
                        .HasDefaultValue(new DateTime(2024, 2, 9, 16, 47, 44, 444, DateTimeKind.Local).AddTicks(8186));
            ...
            modelBuilder.Entity("AB_INVEST.Models.UserInvestmentModel", b =>
                {
                    ...
                    b.Property<DateTime>("StartDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 2, 9, 16, 47, 44, 445, DateTimeKind.Local).AddTicks(472));
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("UserInvestmentModel");
                });
            ...
            modelBuilder.Entity("AB_INVEST.Models.WithdrawModel", b =>
                {
                    b.HasBaseType("AB_INVEST.Models.UserInvestmentModel");

                    b.Property<DateTime>("WithdrawDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 2, 9, 16, 47, 44, 445, DateTimeKind.Local).AddTicks(2338));

                    b.HasDiscriminator().HasValue("WithdrawModel");
                });
